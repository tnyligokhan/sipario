...
//
// ⚠️ KALDIRILANLAR (kullanıcı kararı 2026-08-14): `borcEsigiUretici` · `vadesiGecenUretici`.
// Bekledikleri okuma fonksiyonları (`DayEndRepository.bugunEsigiAsanlar` ·
// `gecikmisBorclular`) de çağrılansız kaldığı için birlikte silindi.
//
