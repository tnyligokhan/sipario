...
<div class="ys-b">
    ...
    <p class="gvd">Satıcı, kanunen zorunlu olmadığı hâlde, ticari bir taahhüt olarak şu imkânı tanır: aboneliğin başlamasından itibaren <strong>14 gün içinde</strong> talep edilmesi hâlinde, ödenen bedelin tamamı iade edilir. Bu, cayma hakkının kendisi değil, Satıcı'nın sözleşmeyle üstlendiği bir iade taahhüdüdür; koşulları "İptal, Cayma ve İade Koşulları" belgesinde düzenlenmiştir.</p>

    <h3 class="h4">6.2. Alıcı tacir veya esnaf ise</h3>
    <p class="gvd">Alıcı hizmeti ticari ya da mesleki faaliyeti kapsamında satın alıyorsa TKHK anlamında tüketici değildir; sözleşmeye 6098 sayılı Türk Borçlar Kanunu'nun genel hükümleri uygulanır ve kanundan doğan bir cayma hakkı bulunmaz. Bu hâlde de yukarıdaki 14 günlük iade taahhüdü aynen geçerlidir — Satıcı bu imkânı alıcı tipine göre ayırmaz.</p>
</div>
