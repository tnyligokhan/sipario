...
<div class="card">
    ...
    <p><strong>Firma kodu:</strong> <code>{{ $tenant->slug }}</code></p>
...
@else
    <div class="card" style="margin-top:1rem;">
        <h2>Abonelik &amp; Durum</h2>
        <p class="hint">Abonelik, kilit, modül ve patron şifresi işlemleri yalnız süper
            yöneticilerdedir. Müşteri ve ürün girişi sizde açıktır.</p>
        <p><a href="{{ route('panel.tenant.export', $tenant->id) }}">Veriyi Dışa Aktar (JSON)</a></p>
    </div>
@endif
